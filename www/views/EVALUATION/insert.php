<?php include "../form_header.php" ?>
		...
		<form id="form_592464" class="appnitro"  method="post" action="../../controllers/EVALUATION/insert.php?array=EVALUATION">
		...
		<div>
			<input id="element_2" name="score" class="element text medium" type="text" maxlength="255" value=""/> 
		</div>
		<div>
