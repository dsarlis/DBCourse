<?php include "../../views/form_header.php" ?>
                ...
                <form id="form_592464" class="appnitro"  method="post" action="../../controllers/PROMOTION/updated.php?date=<?echo $date?>&SSN=<?echo $SSN?>">
                ...
                <div>
                        <input id="element_2" name="new_pos" class="element text medium" type="text" maxlength="255" value="<?echo $new_pos?>"/>
                </div>
                <div>
